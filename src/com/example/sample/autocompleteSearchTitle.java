...
public class autocompleteSearchTitle extends BaseAdapter implements Filterable {
	private Context mContext;
	private List<String> resultList = new ArrayList<String>();
	
	public autocompleteSearchTitle(Context context){
		mContext = context;		
	}	
			...
			protected FilterResults performFiltering(CharSequence constraint) {
                ...
                if (constraint != null) {                	
                    ...
                    try {
						...
						try {
							items = json_result.getJSONObject("tracks").getJSONArray("items");							
