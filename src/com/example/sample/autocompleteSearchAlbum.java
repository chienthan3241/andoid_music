...
public class autocompleteSearchAlbum extends BaseAdapter implements Filterable{
	private Context mContext;
	private List<String> resultList = new ArrayList<String>();
	
	public autocompleteSearchAlbum(Context context){
		mContext = context;
	}
			...
			protected FilterResults performFiltering(CharSequence constraint) {
                ...
                if (constraint != null) {                	
                    ...
                    try {
						...
						try {
							items = json_result.getJSONObject("albums").getJSONArray("items");							
